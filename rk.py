...
def rk_single(f, t_i, y_i, extra, h=0.01):
    y = y_i
    t = t_i 
    step_size = h 
    
    k_1 = f(t, y, extra)
    k_2 = f(t+step_size/2, y+k_1*step_size/2, extra)
    k_3 = f(t+step_size/2, y+k_2*step_size/2, extra)
    k_4 = f(t+step_size, y+k_3*step_size, extra)
